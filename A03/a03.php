<?php
	...
	{
		$valor_salida=$entrada; //Asignamos el valor introducido a la variable
		$valor_salida=$valor_salida+5; //Le sumamos 5 al valor_salida
		$valor_salida++; //Aumentamos en uno el valor obtenido. Lo hacemos antes del return ya que sino no hace la adición.
		return $valor_salida;
	}
?>
<html>
